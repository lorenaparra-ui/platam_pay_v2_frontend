...
export const defaultValuesNaturalPerson = {
  application_type: "natural_person",
  patner_id: "",
  patner_category_id: "",
  sales_rep_id: "",
  first_name: "",
    ...
    sections: [
      {
        ...
        fields: [
          {
            name: "¿Hace cuánto conoces al cliente?",
          ...
          {
            name: "business_number_of_employees",
            label: "En una escala del 1 al 10, ¿qué tan seguro/a te sientes de otorgarle crédito al cliente?",
            type: "number",
            typefield: FieldType.InputNumber,
            useGrouping: false,
            suffix: "puntos",
          ...
          },
          {
            ...
            label: "¿Cuál consideras que sería un cupo de crédito adecuado para este cliente?",
            type: "number",
            typefield: FieldType.InputNumber,
            integerOnly: true,
            useGrouping: true,
